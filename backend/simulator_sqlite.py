# simulator_sqlite.py - Versión corregida para SQLite
import numpy as np
import pandas as pd
...
class TradingSimulator:
    ...
    def create_simulation_account(self, user_id: int, account_name: str, initial_balance: float):
        ...
        # Importar modelos desde main_sqlite para evitar importaciones circulares
        from main_sqlite import SimulationAccount
    ...
    def get_account_positions(self, account_id: int):
        ...
        from main_sqlite import SimulationPosition
    ...
    def get_account_operations(self, account_id: int, limit: int = 100):
        ...
        from main_sqlite import SimulationOperation
    ...
    def execute_buy_order(self, account_id: int, asset_id: int, quantity: float, price: float):
        ...
        from main_sqlite import SimulationAccount, SimulationOperation, SimulationPosition
    ...
    def execute_trade_based_on_prediction(self, account_id: int, prediction: dict):
        ...
        """
        # Importar modelos aquí
        from main_sqlite import SimulationAccount, SimulationPosition, Asset
        ...
        asset = self.db.query(Asset).filter(
            Asset.simbolo == prediction['symbol']
        ).first()
